"""
Django settings for BabuRentalHouse project.
...
SECRET_KEY = 'django-insecure-s8xl80b(sm1!=b%fs8mpgbq8)21_4k#vo)(j5s!5nbnklp0*f2'
...
ROOT_URLCONF = 'BabuRentalHouse.urls'
...
WSGI_APPLICATION = 'BabuRentalHouse.wsgi.application'
